...
export const POI_TYPES = {
  ...
  village: { icon: 'Building2', color: '#D4AF37', label: 'Settlement' },
  ...
  deadtree: { icon: 'Trees', color: '#8B4513', label: 'Tree' },
  ...
  battle: { icon: 'Sword', color: '#DC143C', label: 'Battle Site' },
  bridge: { icon: 'Waypoints', color: '#A0522D', label: 'Bridge' },
