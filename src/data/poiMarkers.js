...
export const POI_TYPES = {
  ...
  sign: { icon: 'Signpost', color: '#DEB887', label: 'Sign' },
  village: { icon: 'Castle', color: '#D4AF37', label: 'Settlement' },
  ...
  swamp: { icon: 'Droplets', color: '#556B2F', label: 'Swamp' },
  hill: { icon: 'MountainSnow', color: '#8FBC8F', label: 'Hill/Island' },
  house: { icon: 'Home', color: '#8B0000', label: 'House' },
  ruin: { icon: 'Skull', color: '#696969', label: 'Ruin' },
  mushroom: { icon: 'Bug', color: '#9932CC', label: 'Special' },
  deadtree: { icon: 'TreeDeciduous', color: '#8B4513', label: 'Tree' },
  tree: { icon: 'TreePine', color: '#228B22', label: 'Tree' },
  farm: { icon: 'Wheat', color: '#DAA520', label: 'Farm' },
  footmen: { icon: 'Footprints', color: '#B22222', label: 'Encounter' },
  lizard: { icon: 'Bug', color: '#2E8B57', label: 'Creature' },
  battle: { icon: 'Swords', color: '#DC143C', label: 'Battle Site' },
  bridge: { icon: 'Milestone', color: '#A0522D', label: 'Bridge' },
